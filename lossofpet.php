	...
	?>
				...
				<div class="row how-1">
					<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						...
						At times like this finding the right person to talk to about our grief, who understands the extent of the loss can be difficult. Some people may fail to see the special bond between an animal and a human and therefore not fully empathise with the loss of a pet.</p>
						<p>Bereavement whether it be human or animal requires specific understanding and empathy, when the loss is of loved and loyal animal, then it takes the compassion of a real animal lover to fully understand the impact such a loss can have on one’s life and well being.
				...
				<div class="row how-2">
					<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						...
						which in turn helps them to move on with their lives.</p>
					</div>
				</div>
			</div>
	<?php
