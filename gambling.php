		...
		<div class="row how-2">
			<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
				...
				<ul>
					...
					<li>More time spent away from usual activities, i.e. Family Time, Hobbies, Homework.</li>
					<li>Preventing others from retrieving post/mail such as Bank Statements / Telephone Bills.</li>
					<li>Sporadic Generosity.</li>
		...
		<div class="row how-1">
			<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
				...
				<ul>
					...
					<li>Increased Lack of Concentration.</li>
					<li>Weight Loss.</li>
					<li>Insomnia.</li>
