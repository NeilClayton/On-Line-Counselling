	...
	?>
				...
				<div class="row how-1">
					<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						...
						You may however still be under a great deal of stress.</p>
						<p>If you know what to expect and how your relationship will grow and change over time, then you will be better prepared to deal with it and adapt more easily to the unavoidable changes in yourself and in the relationship.</p>
				...
				<div class="row how-2">
					<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						...
						<p>Most relationships are complex and an increased understanding will help you to have a happy and successful relationship.</p>
					</div>
				</div>
			</div>
	<?php
