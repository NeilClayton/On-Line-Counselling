	...
	?>
				...
				<div class="row how-1">
					<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						...
						<ul>
							...
							<li>Intrusive thoughts and images.</li>
							<li>Nightmares.</li>
				...
				<div class="row how-2">
					<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						...
						<ul>
							<li>Panicking when reminded of the trauma.</li>
							<li>Being easily upset or angry.</li>
							<li>Extreme alertness.</li>
							<li>A lack of or disturbed sleep.</li>
							<li>Irritability and aggressive behaviour.</li>
				...
				<div class="row how-1">
					<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						...
						<ul>
							<li>Keeping busy.</li>
							<li>Avoiding situations that remind you of the trauma.</li>
							<li>Repressing memories (being unable to remember aspects of the event).</li>
							<li>Feeling detached, cut off and emotionally numb.</li>
				...
				<div class="row how-1">
					<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						...
						<ul>
							<li>A serious accident, for example a car crash.</li>
							<li>An event where you fear for your life.</li>
							<li>Being physically assaulted.</li>
							<li>Being raped or sexually assaulted.</li>
							<li>Abuse in childhood.</li>
							<li>A traumatic childbirth, either as a mother or a partner witnessing a traumatic birth.</li>
							<li>Extreme violence or war.</li>
							<li>Military combat.</li>
							<li>Seeing people hurt or killed.</li>
							<li>A natural disaster, such as flooding or an earthquake.</li>
							<li>Losing someone close to you in disturbing circumstances.</li>
						</ul>
				...
				<div class="row how-2">
					<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						...
						<ul>
							...
							<li>Giving them time to talk and tell their story.</li>
